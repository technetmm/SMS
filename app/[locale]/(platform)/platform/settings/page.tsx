...
export default async function PlatformSettingsOverviewPage() {
  const t = await getTranslations("SettingsOverview.language");
        ...
        <div className="flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Button asChild variant="outline">
              <Link href="/platform/settings/2fa">Enable 2FA</Link>
            </Button>
          </div>
        </div>
      </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <Button asChild className="w-full">
                <Link href="/platform/settings/security">Review security</Link>
              </Button>
            </CardContent>
          </Card>
